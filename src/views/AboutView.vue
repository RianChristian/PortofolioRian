      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Rian Christian Sidin. As a highly motivated Informatics Engineering fresh graduate, I offer hands-on experience in data analysis, including data collection, cleaning, and visualization. I am skilled in leveraging tools such as Python, R, and SQL to extract valuable insights that support strategic decision-making. With experience in collaborating across teams and optimizing web-based solutions through full-stack development, I am confident my skills will add significant value to your company. Eager to take on challenges, I am ready to contribute to your company’s growth through impactful projects.
          </p>
